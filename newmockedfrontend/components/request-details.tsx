...
// Define the request type for better type safety
export type RequestData = (typeof mockRequests)["f3ef3f5e-09c2-4a30-82a2-ecf4f460a1d9"]

export function RequestDetails({ id }: { id: string }) {
  const [request] = useState<RequestData>(mockRequests[id] || mockRequests["f3ef3f5e-09c2-4a30-82a2-ecf4f460a1d9"])
