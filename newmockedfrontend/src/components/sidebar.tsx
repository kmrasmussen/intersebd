  ...
  return (
    ...
    >
      ...
      <div className="p-2 border-t mt-auto">
        {userStatus.is_logged_in || userStatus.is_guest ? (
          // --- User is Logged In or Guest: Show Info + Logout Button ---
          <div className="space-y-2">
            {/* User Info Display */}
            <div className="flex items-center gap-2 w-full p-2 rounded-md text-left">
              <Avatar className="h-8 w-8 shrink-0 border">
                <AvatarImage src={userStatus.is_logged_in ? "/placeholder.svg" : "/guest-avatar.svg"} alt={displayName} />
